...
<?php
    ...
    $select = "SELECT * FROM products INNER JOIN cart ON products.id = cart.productid WHERE cart.userid = $userid and cart.status=1";
        ...
        ?>
                    <div class="row " style="margin-top: -3rem;">
                        ...
                        <div class="col-lg-4"  >
                                ...
                                <div class="card" >
                                    <img class="card-img-top" src="./upload/<?php echo $data['image'] ?>" alt="Card image cap" height="300px">
                                    <div class="card-body">
