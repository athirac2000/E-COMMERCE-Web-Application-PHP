...
<div class="container-fluid">
  ...
  require("db_connectionform.php");
   ...
   $user_id=$_GET['id'];
   $select="SELECT * FROM subcategory where id=$user_id";
  ...
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container">
        ...
        while($row = $selectquery->fetch_assoc()) {
            $name = $row['name'];
            $val=$row['id'];
            $selected = ($data['parentcategory'] == $val) ? "selected" : "";
    ...
    if(isset($_POST["btn"])){
       ...
       $subcategory=$_POST['subcategory'];
        ...
        $update = "UPDATE subcategory SET parentcategory='$parent', subcategory='$subcategory'  WHERE id=$user_id";
