                ...
                <div class="card-body p-md-5">
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4"  method="POST" enctype="multipart/form-data">
                        ...
                        <a href="login.php" class="btn btn-secondary btn-lg" >Login</a>&nbsp;&nbsp;
                          <button name="btn" type="submit" class="btn btn-primary btn-lg" >Register</button>
                        </div>
                      ...
                      if(isset($_POST["btn"])){
                         ...
                         $insert= "INSERT into  register(name,email,password,usertype,approvestatus) VALUES ('$name','$email','$password','1','0')";
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                      ...
                      <img src="./upload/draw1.webp"class="img-fluid" alt="Sample image">
